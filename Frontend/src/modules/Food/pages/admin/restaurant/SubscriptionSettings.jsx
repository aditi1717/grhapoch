          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-gray-500">
                One-time fee collected during restaurant onboarding. Set to ₹0 to hide and skip payment.
              </p>
            </div>
        ...
        <div className="grid gap-6 p-6 sm:grid-cols-[1fr_auto] sm:items-end">
          <div className="max-w-sm space-y-2">
            ...
            <p className="text-xs text-gray-400">
              Restaurants must pay this on the final onboarding step before submission when greater than zero.
            </p>
          </div>
          <div className="rounded-xl border border-dashed border-pink-200 bg-pink-50/50 px-5 py-4 text-center sm:min-w-[180px]">
            <p className="text-[10px] font-semibold uppercase tracking-wider text-gray-400">Current fee</p>
            <p className="mt-1 text-2xl font-bold text-[#FA0272]">
              ₹{Number(settings.onboardingFee || 0).toLocaleString("en-IN")}
            </p>
          </div>
        </div>
      </section>

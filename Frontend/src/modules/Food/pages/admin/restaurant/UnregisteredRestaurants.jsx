        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-sm">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="bg-white divide-y divide-slate-100">
                {loading ? (
                  ...
                  paginatedRestaurants.map((request, index) => (
          ...
          {!loading && filteredRestaurants.length > 0 && (
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mt-4 pt-4 border-t border-slate-200">
              ...
              <p className="text-sm text-slate-600">Showing {Math.min(filteredRestaurants.length, (currentPage - 1) * itemsPerPage + 1)} to {Math.min(currentPage * itemsPerPage, filteredRestaurants.length)} of {filteredRestaurants.length} entries</p>
              <div className="flex items-center gap-2">

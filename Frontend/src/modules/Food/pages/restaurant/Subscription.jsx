      ...
      <div className="sticky bg-white top-0 z-40 px-4 py-3 border-b border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-gray-500">Monthly GMV-based billing • Pay after the month ends</p>
          </div>
        </div>
      </div>
          ...
          <>
                  ...
                  <div className="space-y-1.5">
                    {currentMonth.planCatalog.map((plan) => (
                      ...
                      >
                        ...
                        <span className="font-bold text-gray-900">₹{Number(plan.basePrice).toLocaleString("en-IN")}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-sm font-bold text-gray-900">Dues & Wallet</h2>
              </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 px-4 py-2.5 rounded-lg font-medium text-sm transition-colors ${
                  activeTab === "invoices" ? "bg-black text-white" : "bg-white text-gray-600 border border-gray-200"
                }`}
              >
                Monthly Invoices
              </button>
              <button
                ...
                className={`flex-1 px-4 py-2.5 rounded-lg font-medium text-sm transition-colors ${
                  activeTab === "timeline" ? "bg-black text-white" : "bg-white text-gray-600 border border-gray-200"
                }`}
              >
                Billing Timeline
              </button>
            ...
            {activeTab === "timeline" && (
              <div className="space-y-3">
                {timeline.length === 0 ? (
                  ...
                  timeline.map((tx) => (
                    <div key={tx._id} className="bg-white border border-gray-200 rounded-xl p-3.5">
                      <div className="flex items-center justify-between gap-3">

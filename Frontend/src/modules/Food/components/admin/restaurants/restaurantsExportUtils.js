...
export const exportRestaurantsToExcel = (restaurants, filename = "restaurants") => {
  ...
  const rows = restaurants.map((restaurant, index) => [
    ...
    restaurant.typeLabel || (restaurant.pureVegRestaurant || restaurant.originalData?.pureVegRestaurant ? "Veg" : "Mixed"),
    (restaurant.serviceRadius || restaurant.originalData?.serviceRadius) ? `${restaurant.serviceRadius || restaurant.originalData.serviceRadius} KM` : "N/A",
